(function(global, factory) {
  typeof exports === "object" && typeof module !== "undefined" ? factory(exports, require("react/jsx-runtime"), require("react")) : typeof define === "function" && define.amd ? define(["exports", "react/jsx-runtime", "react"], factory) : (global = typeof globalThis !== "undefined" ? globalThis : global || self, factory(global.uninav = {}, global.jsxRuntime, global.React));
...
var __objRest = (source, exclude) => {
  ...
  const ComponentLoader = (_a) => {
    ...
    const elUuid = react.useRef(`${Date.now()}-${Math.random()}`);
...
`;
  ...
  exports2.FooterNavigation = FooterNavigation;
  exports2.MarketingNavigation = MarketingNavigation;
  exports2.ToolNavigation = ToolNavigation;
});
